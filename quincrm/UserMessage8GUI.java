 ...
 * @author cuong
 */
public class UserMessage8GUI extends javax.swing.JFrame {

    /**
     * Creates new form UserMessage1GUI
     */
    public UserMessage8GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Old Password is incorrect");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserMessage8GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserMessage8GUI().setVisible(true);
            }
        });
    }
