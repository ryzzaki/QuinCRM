 ...
 * @author cuong
 */
public class UserMessage7GUI extends javax.swing.JFrame {

    /**
     * Creates new form UserMessage1GUI
     */
    public UserMessage7GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Password or Captcha is incorrect");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserMessage7GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserMessage7GUI().setVisible(true);
            }
        });
    }
