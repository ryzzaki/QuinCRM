 ...
 * @author cuong
 */
public class UserMessage1GUI extends javax.swing.JFrame {

    /**
     * Creates new form UserMessage1GUI
     */
    public UserMessage1GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Account has been created!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserMessage1GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserMessage1GUI().setVisible(true);
            }
        });
    }
