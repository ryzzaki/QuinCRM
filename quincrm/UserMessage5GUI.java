 ...
 * @author cuong
 */
public class UserMessage5GUI extends javax.swing.JFrame {

    /**
     * Creates new form UserMessage1GUI
     */
    public UserMessage5GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Password is too short");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserMessage5GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserMessage5GUI().setVisible(true);
            }
        });
    }
