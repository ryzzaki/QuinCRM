 ...
 * @author cuong
 */
public class UserMessage10GUI extends javax.swing.JFrame {

    /**
     * Creates new form UserMessage1GUI
     */
    public UserMessage10GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Account has been deleted");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserMessage10GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserMessage10GUI().setVisible(true);
            }
        });
    }
